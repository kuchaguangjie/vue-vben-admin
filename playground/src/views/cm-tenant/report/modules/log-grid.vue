...
import { getCmTenantCommissionLogPage } from '#/api/cm-tenant';
...
const [LogGrid] = useVbenVxeGrid({
    ...
    proxyConfig: {
      ajax: {
        query: async (params: PageParams, formValues) => {
          return doPageQuery(getCmTenantCommissionLogPage, params, formValues);
        },
      },
    },
    rowConfig: {
  ...
  } as VxeTableGridOptions<CmTenantReportApi.CommissionLogRow>,
});
</script>

<template>
  <LogGrid table-title="租户分佣流水">
    <template #status="{ row }">
